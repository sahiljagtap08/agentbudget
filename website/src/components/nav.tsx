    ...
    <nav className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-[1200px] items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-7 md:flex">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-accent/20 bg-accent/10 px-2.5 py-0.5 font-mono text-[11px] font-medium text-accent-bright">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 rounded-md bg-gradient-accent px-3.5 py-1.5 text-[13px] font-semibold text-white transition-opacity hover:opacity-90 hover:no-underline"
          >
