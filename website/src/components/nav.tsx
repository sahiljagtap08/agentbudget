    ...
    <nav className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-[1200px] items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-7 md:flex">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-accent-green/20 bg-accent-green/10 px-2.5 py-0.5 font-mono text-[11px] font-medium text-accent-green">
            <span className="h-1.5 w-1.5 rounded-full bg-accent-green" style={{ animation: "pulse-dot 2s ease-in-out infinite" }} />
            v0.1
          </span>
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 rounded-md bg-foreground px-3.5 py-1.5 text-[13px] font-semibold text-background transition-opacity hover:opacity-90 hover:no-underline"
          >
