  ...
  return (
    <div className="min-h-screen bg-noise">
      ...
      <div className="mx-auto flex max-w-[1200px]">
        ...
        {/* Mobile nav toggle */}
        <button
          className="fixed bottom-6 right-6 z-50 flex h-10 w-10 items-center justify-center rounded-full border border-border bg-surface text-muted-foreground md:hidden"
